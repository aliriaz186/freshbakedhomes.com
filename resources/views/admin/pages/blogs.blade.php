        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    ...
                    <a href="{{ url('admin/create-blog') }}" class="btn btn-sm btn-info ml-3">Add New</a>
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                    ...
                    @foreach ($blogs as $blog)
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{url('')}}/{{$blog->image}}" alt="img" width="100%" height="190" class="">
                            </td>
                            ...
                            <td class="project-actions text-right d-flex justify-content-around">
                                ...
                                <a class="btn btn-info btn-sm" href="{{ url('admin/edit-blog') }}/{{$blog->id}}">
