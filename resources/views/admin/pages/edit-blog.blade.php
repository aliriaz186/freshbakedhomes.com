...
@section('content')
    ...
    <section class="content">
        {{-- Form  --}}
        <form action="{{ url('/admin/update-blog') }}" method="POST" enctype="multipart/form-data" id="mainform">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="height: 350px" type="text" name="description" id="description" class="form-control" placeholder="Write description" >{{$blog->description}}</textarea>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <img src="{{url('')}}/{{$blog->image}}" alt="img" width="20%" height="190">
                                </div>
