        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    <h1 class="m-0 text-dark">Our Concept Page Text</h1>

                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Our Concept Page Text</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Our Concept Page Text</h3>
            ...
            <div class="card-body p-2">
                <form action="{{url('/admin/update-text')}}" method="post">
                    ...
                    <input type="hidden" name="type" value="our-concept-text">
                    <br>
