        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    <h1 class="m-0 text-dark">Home Page Images</h1>
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Initial Container Home Concept Images</h3>
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid"
                    ...
                    @foreach ($images as $image)
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{asset($image->image)}}" alt="img" style="width: 200px;height: 200px" class="">
                            </td>
