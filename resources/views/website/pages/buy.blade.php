                ...
                <ul>
                    ...
                    <li>
                        <p>Questions always welcome. We consider each customer a new friend. We want you to have a
                            ...
                            the
                            benefits and delights of a container home. (LINK FOR DISCUSSION ROOM)</p>
                    </li>
                    <li>
                        <p>Contact us to start your path to a new home: (Link for quick contact form) We look forward to
                            meeting you.</p>
                    </li>
                </ul>
